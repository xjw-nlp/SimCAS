...
def wcep_setting(args):
    ...
    args.pretrained = getattr(args, "pretrained", None)
    args.model_type = getattr(args, "model_type", "/apdcephfs_qy3/share_1565115/jonxie/model_base/bart-base")
    args.dataset_name = getattr(args, "dataset_name", "/apdcephfs_qy3/share_1565115/jonxie/data_base/WCEP-10")
    args.feat_names = getattr(args, "feat_names", ['document', 'summary'])
...
def arxiv_setting(args):
    ...
    args.pretrained = getattr(args, "pretrained", None)
    args.model_type = getattr(args, "model_type", "/apdcephfs_qy3/share_1565115/jonxie/model_base/bart-base")
    args.dataset_name = getattr(args, "dataset_name", "/apdcephfs_qy3/share_1565115/jonxie/data_base/arxiv-summarization")
    args.feat_names = getattr(args, "feat_names", ['article', 'abstract'])
...
def govreport_setting(args):
    ...
    args.feat_names = getattr(args, "feat_names", ['report', 'summary'])
    args.warmup_steps = getattr(args, "warmup_steps", 1600)
    args.normalize = getattr(args, "normalize", True)
    args.grad_norm = getattr(args, "grad_norm", 0)
    args.seed = getattr(args, "seed", 777)
...
def summscreen_setting(args):
    ...
    args.pretrained = getattr(args, "pretrained", None)
    args.model_type = getattr(args, "model_type", "/apdcephfs_qy3/share_1565115/jonxie/model_base/bart-base")
    args.dataset_name = getattr(args, "dataset_name", "/apdcephfs_qy3/share_1565115/jonxie/data_base/summ_screen")
    args.feat_names = getattr(args, "feat_names", ['Transcript', 'Recap'])
    args.warmup_steps = getattr(args, "warmup_steps", 6400)
    args.normalize = getattr(args, "normalize", True)
    args.grad_norm = getattr(args, "grad_norm", 0)
    args.seed = getattr(args, "seed", 777)
