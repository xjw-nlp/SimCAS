def multinews_setting(args):
    ...
    args.model_type = getattr(args, "model_type", "/your_path/bart-base")
    args.dataset_name = getattr(args, "dataset_name", "/your_path/multinews_bart_512")
...
def wcep_setting(args):
    ...
    args.pretrained = getattr(args, "pretrained", None)
    args.model_type = getattr(args, "model_type", "/your_path/bart-base")
    args.dataset_name = getattr(args, "dataset_name", "/your_path/wcep_bart_512")
...
def arxiv_setting(args):
    ...
    args.pretrained = getattr(args, "pretrained", None)
    args.model_type = getattr(args, "model_type", "/your_path/bart-base")
    args.dataset_name = getattr(args, "dataset_name", "/your_path/arxiv_bart_512")
...
def pubmed_setting(args):
    ...
    args.pretrained = getattr(args, "pretrained", None)
    args.model_type = getattr(args, "model_type", "/your_path/bart-base")
    args.dataset_name = getattr(args, "dataset_name", "/your_path/pubmed_bart_512")
    args.warmup_steps = getattr(args, "warmup_steps", 10000)
    args.normalize = getattr(args, "normalize", True)
    args.grad_norm = getattr(args, "grad_norm", 0)
...
def govreport_setting(args):
    ...
    args.pretrained = getattr(args, "pretrained", None)
    args.model_type = getattr(args, "model_type", "/your_path/bart-base")
    args.dataset_name = getattr(args, "dataset_name", "/your_path/govreport_bart_512")
    args.warmup_steps = getattr(args, "warmup_steps", 1600)
    args.normalize = getattr(args, "normalize", True)
    args.grad_norm = getattr(args, "grad_norm", 0)
    args.seed = getattr(args, "seed", 777)
...
def summscreen_setting(args):
    ...
    args.pretrained = getattr(args, "pretrained", None)
    args.model_type = getattr(args, "model_type", "/your_path/bart-base")
    args.dataset_name = getattr(args, "dataset_name", "/your_path/summscreen_bart_512")
    args.warmup_steps = getattr(args, "warmup_steps", 6400)
    args.normalize = getattr(args, "normalize", True)
    args.grad_norm = getattr(args, "grad_norm", 0)
    args.seed = getattr(args, "seed", 777)
...
def nrtv_setting(args):
    ...
    args.pretrained = getattr(args, "pretrained", None)
    args.model_type = getattr(args, "model_type", "/your_path/bart-base")
    args.dataset_name = getattr(args, "dataset_name", "/your_path/nrtv_bart_512")
    args.warmup_steps = getattr(args, "warmup_steps", 1600)
    args.normalize = getattr(args, "normalize", True)
    args.grad_norm = getattr(args, "grad_norm", 0)
    args.seed = getattr(args, "seed", 777)
