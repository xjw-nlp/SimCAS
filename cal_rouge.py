...
_ROUGE_PATH = '/root/evaluation/ROUGE-RELEASE-1.5.5/'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--type", type=str, help="dataset type", required=True)
    ...
    if args.python:
        ...
        # scorer = BERTScorer(lang="en", rescale_with_baseline=True, device='cuda:2')
        ...
        for i in tqdm(range(num)):
            ...
            # bs += F1.sum().item()
            cnt += 1
        # print("rouge1: %.6f, rouge2: %.6f, rougeL: %.6f, BERTScore: %.6f"%(rouge1 / cnt * 100, rouge2 / cnt * 100, rougeLsum / cnt * 100, bs / cnt * 100))
